...
export default function Servicostrabalho() {
  ...
  <div className="max-w-6xl mx-auto px-4 lg:px-4 md:px-8">
    
    {/* Título */}
    <div className="mb-14">
      <h1 className="text-black leading-tight mb-[2%] text-2xl md:text-4xl lg:text-5xl">
        Serviços de{" "}
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-10">
      {Servicos.map((index, key) => (
        ...
        >
          ...
          {/* Ícone (NÃO ALTERADO) */}
          <div className="absolute left-1/2 top-0 -translate-x-1/2 -translate-y-1/2 z-20 border-x-8 lg:border-x-4 border-white rounded-full bg-white">
            <Image
              src={index.imageicon}
              alt="icone"
              width={50}
          ...
          <div className="p-6 pt-8">
            <h2 className="text-lg md:text-xl font-semibold text-[#1b73a0]">
              {index.title}
            </h2>
    ...
    {/* Botão */}
    <div className="mt-6">
      <Link href="/Servicos" className="bg-[#44a631] hover:bg-[#3d8f2d] text-white px-6 py-3 rounded-full font-medium shadow-lg">
